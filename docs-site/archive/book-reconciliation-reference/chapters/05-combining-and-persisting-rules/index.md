...
!!! note "Unreconciled reference chapter"
    This page retains the donor's organization and older source basis. It supplies reference material for the approved Chapters 7 and 8, not their completed replacements. Use [Chapter 1's small engine contrast](../01-two-rule-engines/index.md#individual-rules-or-compatible-combinations) to distinguish individual rules from compatible combinations; see the [book contents](../index.md) for review status.
